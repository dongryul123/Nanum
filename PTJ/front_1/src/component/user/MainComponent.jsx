                ...
                <div className="row">
                  <div className="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="d-lg-flex">
                      <a href="#about" className="btn-get-started scrollto">모임 찾으러 가기</a>
                      <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" className="venobox btn-watch-video" data-vbtype="video" data-autoplay="true">Hot Talent !<i className="icofont-play-alt-2"></i></a>
                    </div>
                  </div>
